...
// Renders the welcome composer and transitions first user input into a new chat thread route.
...
// Renders the welcome composer UI with attachment support and send/cancel actions.
