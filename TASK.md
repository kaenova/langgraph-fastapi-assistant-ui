I have Next.js and Fast API application. Read the AGENTS.md first. I want you to implement Assistant UI - Assistant Transport approeach to be integrated with Fast API backend which have langgraph and its tooling. 

For Assistant Transport integration you can crawl it in
